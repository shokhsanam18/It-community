export const questions = [
    {
      id: 1,
      question: "Is the UZ IT COMMUNITY chat the official public group of the IT Community of Uzbekistan?",
      options: [
    ...
    {
      id: 2,
      question: "Can you post random IT-related content in the UZ IT COMMUNITY chat?",
      options: [
        "No, only content affiliated with the IT Community is allowed",
        "Yes, any IT content is fine",
        "Sure, if it’s interesting enough",
      ],
      correctAnswer: "No, only content affiliated with the IT Community is allowed",
    },
    {
      id: 3,
      question: "Can you share pictures from events that are not affiliated with the IT Community?",
      options: [
...
export const explanations = {
  ...
  2: "The chat is for volunteers only. If content isn't affiliated with the community or Shavkat aka, don't post it.",
  3: "You may share photos only if the event is affiliated or you have Shavkat aka's permission.",
  4: "Only events co-organized by the IT Community or approved by Shavkat aka may be posted.",
  5: "You may only post vacancies with permission or if they are exclusive to IT Community volunteers.",
  6: "Only admins can add members. Others must contact admins for the selection process.",
  7: "Visit aka.ms/nohello — don’t send one-word messages like 'hello', just write your full thought.",
  8: "The '2G Community' is a joke about replying late. Roman inspired it by replying to an old message.",
  9: "Roman jokingly called himself the most humble and handsome, and the group embraced it.",
  10: "Keling Tanishaylik is a networking bot for volunteers to connect online or in-person.",
  11: "To join, vote in the weekly poll and press 'start' in the bot. Do not delete the bot chat.",
